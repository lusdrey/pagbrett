<table style="border: hidden" class="default">
  <tr>
    <td COLSPAN=2><h1>Bienvenid@ Usuario.</h1></td>
  </tr>
  <tr>
 <td><br>
<a href="login.php"><input type="button" class="boton" value="Iniciar sesión"></a><br>
</td><td><br>
<a href="register.php"><input type="button" class="bor" value="Registrarse"></a></a>
</td>
  </tr><tr>
 <td COLSPAN=2><br>
<h1>Contenido</h1>
